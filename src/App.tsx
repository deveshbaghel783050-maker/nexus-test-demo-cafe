...
export default function App() {
  ...
  useEffect(() => {
    const cachedCart = localStorage.getItem('test-demo-cafe_cart');
    if (cachedCart) {
      try {
    ...
    const cachedBookings = localStorage.getItem('test-demo-cafe_bookings');
    if (cachedBookings) {
      try {
  ...
  const saveCart = (newCart: CartItem[]) => {
    setCart(newCart);
    localStorage.setItem('test-demo-cafe_cart', JSON.stringify(newCart));
  };
  ...
  const handleAddBooking = (newBooking: TableBooking) => {
    ...
    localStorage.setItem('test-demo-cafe_bookings', JSON.stringify(updated));
  };
            ...
            <section className="max-w-5xl mx-auto px-6 space-y-8">
              <div className="text-center max-w-xl mx-auto space-y-2">
                ...
                <p className="text-xs text-brand-outline font-sans">
                  Hover or click on our active visual coordinates to learn the background story of our beautiful Delhi furniture.
                </p>
              </div>
        ...
        {activeTab === 'menu' && (
          <div className="max-w-5xl mx-auto px-6 pt-8 space-y-8 animate-fade-in-up">
            ...
            <div className="text-center max-w-xl mx-auto space-y-2 mb-4">
              ...
              <p className="text-xs text-brand-outline font-sans leading-relaxed">
                From organic edamame purées to slow-whisked Japanese ceremony matcha lattes, everything is made in Delhi.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-brand-outline leading-relaxed font-sans max-w-xs">
              © 2024 Test Demo Cafe Delhi. Handcrafted using eco-conscious Mumbai local clay and slow artisanal materials.
            </p>
